...
#define NFS_MAXDATA_TCP 1048576
...
rpcinfo get_rpcinfo(struct svc_req *, mode_t mode);
 ...
 */
/**
 * Tests show that Linux (ubuntu,centos) client only takes 102 dirents
 * (exclude dot and dotdot) even the request indicates the client buffer
 * size is 32KB. MacOS only does readdir. It accepts all the dirents in the
 * response and then do a series of lookup requests to get dirent
 * attributes.
 */
